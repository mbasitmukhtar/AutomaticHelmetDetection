...
import sys
import os
import libs.tracking_lib as tracking_lib
...
data_folder_path = '/home/hec/waseem/UAV/tracking/data'
detection_folder_path = os.path.join(data_folder_path, 'detections')
